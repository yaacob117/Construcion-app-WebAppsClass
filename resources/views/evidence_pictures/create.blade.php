...
<body class="bg-gray-100 text-gray-900">
    ...
    <div class="container mx-auto py-8">
        <h1 class="text-3xl font-bold mb-6 text-center">Create Evidence Picture</h1>

        <form action="{{ route('evidence_pictures.store') }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" name="sent_photo_url" id="sent_photo_url" class="mt-1 block w-full border-gray-300 rounded-md" required>
            </div>

            <div class="mb-4">
                <label for="received_photo_url" class="block text-sm font-medium text-gray-700">Received Photo URL</label>
                <input type="text" name="received_photo_url" id="received_photo_url" class="mt-1 block w-full border-gray-300 rounded-md">
            </div>

            <div class="mb-4">
                <label for="sent_at" class="block text-sm font-medium text-gray-700">Sent At</label>
                <input type="datetime-local" name="sent_at" id="sent_at" class="mt-1 block w-full border-gray-300 rounded-md" required>
            </div>

            <div class="mb-4">
                <label for="received_at" class="block text-sm font-medium text-gray-700">Received At</label>
                <input type="datetime-local" name="received_at" id="received_at" class="mt-1 block w-full border-gray-300 rounded-md">
            </div>

            <div class="mb-4">
                <label for="uploaded_by" class="block text-sm font-medium text-gray-700">Uploaded By</label>
                <input type="text" name="uploaded_by" id="uploaded_by" class="mt-1 block w-full border-gray-300 rounded-md" required>
            </div>
